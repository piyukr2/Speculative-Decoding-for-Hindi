...
All code, configs, trained checkpoints, and evaluation logs are available in our \href{https://github.com/piyukr2/Speculative-Decoding-for-Hindi}{GitHub repository}.  The \texttt{configs/default.yaml} specifies all hyperparameters, and \texttt{requirements.txt} pins all dependencies.
